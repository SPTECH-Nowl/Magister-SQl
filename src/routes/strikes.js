...
router.put('/editarStrike', (req, res) => {
    strikeController.editarStrike(req, res);
});
...
router.get("/strikesToast/:codInstituicao", function (req, res) {
    strikeController.strikesToast(req, res);
})
